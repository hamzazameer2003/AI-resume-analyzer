      ...
      <section className="mx-auto flex max-w-6xl flex-col gap-10 px-6 pb-16 pt-8">
        <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/70 px-4 py-1 text-xs text-slate shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/signup"
                className="rounded-full bg-ink px-5 py-2.5 text-sm text-fog transition hover:-translate-y-0.5"
              >
                Start Free
              </Link>
              <Link
                href="/login"
                className="rounded-full border border-ink/20 px-5 py-2.5 text-sm text-ink transition hover:-translate-y-0.5"
              >
                Already a member
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-3xl border border-white/70 bg-white/80 p-6 shadow-xl animate-float">
              <p className="text-sm text-slate">Latest Resume ATS Score</p>
              ...
              <div className="mt-6 h-2 w-full rounded-full bg-fog">
                <div className="h-2 w-3/4 rounded-full bg-ink" />
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="rounded-3xl border border-white/70 bg-white/70 p-8 shadow-lg">
          <div className="grid gap-6 md:grid-cols-3">
            <div>
              <p className="text-sm uppercase tracking-widest text-slate">How it works</p>
              <h2 className="mt-3 text-2xl font-semibold">A clean, guided flow</h2>
            </div>
            <div className="space-y-4 text-sm text-slate md:col-span-2">
        ...
        <section className="flex flex-col items-center gap-4 rounded-3xl bg-ink px-8 py-10 text-center text-fog shadow-xl">
          ...
          <Link
            href="/signup"
            className="rounded-full bg-fog px-5 py-2.5 text-sm text-ink transition hover:-translate-y-0.5"
          >
            Create your account
          </Link>
        </section>
